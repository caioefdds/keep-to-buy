        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h1 class="card-title">Lançamento de despesas</h1>
                </div>
                    ...
                    <div class="row row-sm">
                        <div class="card-pay">
                            <ul class="tabs-menu nav justify-content-center">
                                <li @click="changeType(1)"><a href="#tab20" class="active" data-bs-toggle="tab"><i class="fa fa-calendar-check-o"></i> Despesa Fixa</a></li>
                                <li @click="changeType(2)"><a href="#tab21" data-bs-toggle="tab" class=""><i class="fa fa-credit-card"></i>  Despesa Variável</a></li>
                            </ul>
...
export default {
    ...
    methods: {
        ...
        save(redirect = true) {
            ...
            this.axios.post('/admin/expenses/create', this.formData).then((result) => {
